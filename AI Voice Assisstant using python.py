...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('ajaysrirambab@gmail.com', 'sriram53210')
...
if _name_ == "_main_":
    ...
    #logic for executing tasks based on query
        ...
        if 'open youtube' in query:
            ...
            speak("I have been created by Ajay.")
            ...
            speak("I am your virtual assistant created by Ajay")

        elif 'reason for creating you' in query:
            speak("I was created as a Minor project by Mister Raja ")
